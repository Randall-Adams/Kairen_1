Public Class Launcher
    ' Versions
    Dim Version_Current_Release As String = "0"
    ...
    Private Sub Launcher_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        UpdateAction("")
        If CBool(File_Options.GetValueByText(o_AutoLaunch)) = True Then
            If d_pb_Progress.Value = d_pb_Progress.Maximum Then
    ...
    Private Sub ReadOptionsFile()
        ...
        Select Case File_Options.ReadLine ' File Version..
            Case "0.1" ' File Version 0.1
                ...
                File_Options.AdditonalData(File_Options.CurrentIndex) = d_chkbx_ToggleOptions.Items.Item(d_chkbx_ToggleOptions.Items.Count - 1).ToString
    ...
    Private Sub d_chkbx_ToggleOptions_ItemCheck(sender As System.Object, e As System.Windows.Forms.ItemCheckEventArgs) Handles d_chkbx_ToggleOptions.ItemCheck
        ...
        File_Options.UpdateValueByText(TextToFind, e.NewValue)
    ...
    Private Sub LoadOptionsFolder()
        ...
        Else : UpdateAction("Installion Folder Found.")
        End If
        ...
        ReadOptionsFile()
        If CBool(File_Options.GetValueByText(o_AutoInstallNew)) = True Then
        ...
        End If
        If CBool(File_Options.GetValueByText(o_AutoRepairMissing)) = True Then
            UpdateAction(o_AutoRepairMissing & " is set to true.")
            InstallMissingFiles()
        Else : UpdateAction(o_AutoRepairMissing & " is set to false.")
        End If
        If CBool(File_Options.GetValueByText(o_AutoRepairBroken)) = True Then
